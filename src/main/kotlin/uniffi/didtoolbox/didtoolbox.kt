...
public interface TrustDidWebProcessorInterface {
    ...
    fun `create`(`url`: String, `keyPair`: Ed25519KeyPair): String
    
    fun `deactivate`(`didTdw`: String, `keyPair`: Ed25519KeyPair): String
    
    fun `read`(`didTdw`: String): String
    
    fun `update`(`didTdw`: String, `didDoc`: String, `keyPair`: Ed25519KeyPair): String
...
data class DidDoc (
    ...
    var `authentication`: List<VerificationMethod>, 
    var `capabilityInvocation`: List<VerificationMethod>, 
    var `capabilityDelegation`: List<VerificationMethod>, 
    var `assertionMethod`: List<VerificationMethod>, 
...
public object FfiConverterTypeDidDoc: FfiConverterRustBuffer<DidDoc> {
    ...
    override fun allocationSize(value: DidDoc) = (
            ...
            FfiConverterSequenceTypeVerificationMethod.allocationSize(value.`authentication`) +
            FfiConverterSequenceTypeVerificationMethod.allocationSize(value.`capabilityInvocation`) +
            FfiConverterSequenceTypeVerificationMethod.allocationSize(value.`capabilityDelegation`) +
            FfiConverterSequenceTypeVerificationMethod.allocationSize(value.`assertionMethod`) +
    ...
    override fun write(value: DidDoc, buf: ByteBuffer) {
            ...
            FfiConverterSequenceTypeVerificationMethod.write(value.`authentication`, buf)
            FfiConverterSequenceTypeVerificationMethod.write(value.`capabilityInvocation`, buf)
            FfiConverterSequenceTypeVerificationMethod.write(value.`capabilityDelegation`, buf)
            FfiConverterSequenceTypeVerificationMethod.write(value.`assertionMethod`, buf)
