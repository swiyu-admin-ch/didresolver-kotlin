...
fun uniffi_did_webvh_checksum_method_webverifiablehistory_get_did_doc_obj_thread_safe(
): Short
fun uniffi_did_webvh_checksum_method_webverifiablehistory_get_did_log(
): Short
fun uniffi_did_webvh_checksum_method_webverifiablehistory_get_did_method_parameters(
): Short
fun uniffi_did_webvh_checksum_method_webverifiablehistorydidmethodparameters_get_scid(
): Short
fun uniffi_did_webvh_checksum_method_webverifiablehistorydidmethodparameters_get_update_keys(
): Short
fun uniffi_did_webvh_checksum_method_webverifiablehistorydidmethodparameters_is_deactivated(
): Short
...
fun uniffi_did_webvh_checksum_constructor_webverifiablehistory_resolve(
): Short
...
fun uniffi_did_webvh_fn_constructor_webverifiablehistory_resolve(`didWebvh`: RustBuffer.ByValue,`didLog`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
...
fun uniffi_did_webvh_fn_method_webverifiablehistory_get_did_doc_obj_thread_safe(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun uniffi_did_webvh_fn_method_webverifiablehistory_get_did_log(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_did_webvh_fn_method_webverifiablehistory_get_did_method_parameters(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun uniffi_did_webvh_fn_clone_webverifiablehistorydidmethodparameters(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
fun uniffi_did_webvh_fn_free_webverifiablehistorydidmethodparameters(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Unit
fun uniffi_did_webvh_fn_method_webverifiablehistorydidmethodparameters_get_scid(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_did_webvh_fn_method_webverifiablehistorydidmethodparameters_get_update_keys(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
fun uniffi_did_webvh_fn_method_webverifiablehistorydidmethodparameters_is_deactivated(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Byte
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_did_webvh_checksum_method_webverifiablehistory_get_did_doc_obj_thread_safe() != 55651.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_did_webvh_checksum_method_webverifiablehistory_get_did_log() != 45523.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_did_webvh_checksum_method_webverifiablehistory_get_did_method_parameters() != 9579.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_did_webvh_checksum_method_webverifiablehistorydidmethodparameters_get_scid() != 38683.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_did_webvh_checksum_method_webverifiablehistorydidmethodparameters_get_update_keys() != 1294.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_did_webvh_checksum_method_webverifiablehistorydidmethodparameters_is_deactivated() != 55556.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class WebVerifiableHistory: Disposable, AutoCloseable, WebVerifiableHistoryInterface
{
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_did_webvh_fn_method_webverifiablehistory_get_did_doc_obj_thread_safe(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_did_webvh_fn_method_webverifiablehistory_get_did_method_parameters(
        it, _status)
}
    }
    )
...
open class WebVerifiableHistoryDidMethodParameters: Disposable, AutoCloseable, WebVerifiableHistoryDidMethodParametersInterface
{
    ...
    private class UniffiCleanAction(private val pointer: Pointer?) : Runnable {
        override fun run() {
            pointer?.let { ptr ->
                uniffiRustCall { status ->
                    UniffiLib.INSTANCE.uniffi_did_webvh_fn_free_webverifiablehistorydidmethodparameters(ptr, status)
                }
            }
        }
    }
    ...
    fun uniffiClonePointer(): Pointer {
        return uniffiRustCall() { status ->
            UniffiLib.INSTANCE.uniffi_did_webvh_fn_clone_webverifiablehistorydidmethodparameters(pointer!!, status)
        }
    }
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_did_webvh_fn_method_webverifiablehistorydidmethodparameters_get_scid(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_did_webvh_fn_method_webverifiablehistorydidmethodparameters_get_update_keys(
        it, _status)
}
    }
    )
    ...
    callWithPointer {
    uniffiRustCall() { _status ->
    UniffiLib.INSTANCE.uniffi_did_webvh_fn_method_webverifiablehistorydidmethodparameters_is_deactivated(
        it, _status)
}
    }
    )
 ...
 * @suppress
 */
public object FfiConverterTypeWebVerifiableHistoryDidMethodParameters: FfiConverter<WebVerifiableHistoryDidMethodParameters, Pointer> {

    override fun lower(value: WebVerifiableHistoryDidMethodParameters): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): WebVerifiableHistoryDidMethodParameters {
        return WebVerifiableHistoryDidMethodParameters(value)
    }
