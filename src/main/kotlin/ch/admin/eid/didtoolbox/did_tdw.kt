...
fun uniffi_did_tdw_checksum_method_trustdidweb_get_did_doc_obj(
): Short
...
fun uniffi_did_tdw_fn_method_trustdidweb_get_did_doc_obj(`ptr`: Pointer,uniffi_out_err: UniffiRustCallStatus, 
): Pointer
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_did_tdw_checksum_method_trustdidweb_get_did_doc_obj() != 62866.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
open class TrustDidWeb: Disposable, AutoCloseable, TrustDidWebInterface
{
    ...
    UniffiLib.INSTANCE.uniffi_did_tdw_fn_method_trustdidweb_get_did_doc_obj(
        it, _status)
}
    }
    )
